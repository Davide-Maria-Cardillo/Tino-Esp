...
const IPAddress localIP(192, 168, 0, 10);  //6 LED+BUTTON RIGHT TASK 2
...
void loop() {
  ...
  if (buttonState == HIGH) {
    ...
    delay(100);
    // Invia messaggio a door2 (ESP7)
    sendMsg("3", door2IP, MY_UDP_PORT);
    Serial.println("Sent '3' to door2 for positive feedback.");
  }
} 
