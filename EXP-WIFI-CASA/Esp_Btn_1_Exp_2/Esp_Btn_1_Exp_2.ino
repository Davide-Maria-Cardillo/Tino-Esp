...
const IPAddress localIP(192, 168, 0, 8);  //4 LED+BUTTON WRONG TASK 2

// IP Addresses for other devices
const IPAddress buttonWrong2IP(192, 168, 0, 9);  //5 LED+BUTTON WRONG TASK 2
...
void loop() {
  ...
  if (buttonState == HIGH) {
    ...
    sendMsg("6", door2IP, MY_UDP_PORT);
    Serial.println("Sent '6' to door2 for negative feedback.");
    sendMsg("6", pcIP, MY_UDP_PORT);
    Serial.println("Sent '6' to PC to update counter.");
